# AI Protocol NFT Factory #
NFT Factory is a helper smart contract responsible for minting arbitrary NFTs.
...
* NFT Factory
    * Smart Contract(s):
        * [NFTFactory](contracts/protocol/NFTFactory.sol) – NFTFactory implementation
    * Test(s):
      * [nft_factory.js](test/protocol/nft_factory.js) – functional requirements tests
* NFT Factory v2 (Upgradeable)
   * Smart Contract(s):
      * [NFTFactoryV2](contracts/protocol/NFTFactoryV2.sol) – NFTFactory V2 implementation
      * Interfaces
         * [ERC721](contracts/interfaces/ERC721Spec.sol)
   * Test(s):
      * [nft_factory_v2.js](test/protocol/nft_factory_v2.js) – functional requirements tests
* NFT Factory v3 (Upgradeable)
   * Smart Contract(s):
      * [NFTFactoryV3](contracts/protocol/NFTFactoryV3.sol) – NFTFactory V3 implementation
      * Interfaces
         * [ERC721](contracts/interfaces/ERC721Spec.sol)
   * Test(s):
      * [nft_factory_v3.js](test/protocol/nft_factory_v3.js) – functional requirements tests
...
1. Clone the repository  
    ```git clone git@github.com:AI-Protocol-Official/nft-factory-contracts.git```
2. Navigate into the cloned repository  
    ```cd nft-factory-contracts```
